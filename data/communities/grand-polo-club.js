export const grandPoloClubData = {
  slug: "grand-polo-club",
  name: "Grand Polo Club & Resort",

  hero: {
    imageSrc: "/grand-polo-club-emaar/1.png",
    ...
    description:
      "Experience Dubai\u2019s premier polo-inspired residential community. Grand Polo Club & Resort by Emaar combines equestrian heritage with modern architecture in a low-density, nature-focused neighbourhood.",
  },

  overview: {
    title: "Equestrian Heritage Meets Modern Luxury",
    paragraphs: [
    ...
    stats: [
      { value: "70%", label: "Green Coverage", description: "Extensive landscaped areas" },
      { value: "24/7", label: "Security", description: "Gated community" },
      { value: "Professional", label: "Polo Fields", description: "Equestrian facilities" },
      { value: "Resort-style", label: "Amenities", description: "World-class facilities" },
    ],
    quickFacts: [
    ...
    visionTitle: "Equestrian-Inspired Design",
    visionParagraphs: [
    ...
    visionImage: "/grand-polo-club-emaar/3.png",
    visionImageAlt: "Equestrian-inspired design",
  },

  developer: {
    title: "Emaar Properties \u2013 Developer Profile",
    paragraphs: [
  ...
  lifestyle: {
    title: "Equestrian & Resort Lifestyle",
    subtitle:
    ...
    features: [
      {
        ...
        title: "Polo Fields",
        description:
          "Large grass fields for sporting and community events, forming the sporting heart of the community",
      },
      {
        icon: "FaUmbrellaBeach",
        title: "Resort Pools",
        description:
          "Multiple swimming pools with resort-style facilities for relaxation and recreation",
      },
      {
        icon: "FaTree",
        title: "Green Parks",
        description:
          "Extensive landscaped gardens and walking trails throughout the community",
      },
      {
        icon: "FaCompass",
        title: "Equestrian Club",
        description:
          "Clubhouse with viewing points over fields and equestrian facilities",
      },
    ],
    ...
    targetResidents: "Families, equestrian enthusiasts, luxury home seekers",
    developmentPhase: "Multi-phase off-plan development",
  ...
  location: {
    ...
    mapEmbedUrl:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14467.119522923302!2d55.20950857833818!3d24.9736027!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f730021d4dc01%3A0xf5a2e447365938cc!2sGrand%20Polo%20Club%20%26%20Resort!5e0!3m2!1sen!2s!4v1772188812672!5m2!1sen!2s",
    keyConnections: [
      "Near Expo Road (E77) and Emirates Road (E611) junction",
      "Excellent connectivity to Expo City Dubai and Al Maktoum Airport",
      "Adjacent to Dubai Investments Park with shopping and dining",
      "25 minutes to Downtown Dubai via major highways",
    ],
    features: [
      { icon: "FaMapMarkerAlt", title: "Expo City Dubai", description: "10 minutes drive" },
      { icon: "FaCompass", title: "Al Maktoum Airport", description: "15 minutes drive" },
      { icon: "FaBuilding", title: "Dubai Investments Park", description: "Adjacent" },
      { icon: "FaWind", title: "Emirates Road", description: "Direct access" },
    ],
  },
  ...
  propertyTypes: {
    ...
    badgeText: "Grand Polo",
    types: [
      {
        name: "3-5 Bedroom Villas",
        tag: "Luxury configurations with polo field views",
        perks: ["Private gardens", "Spacious layouts", "Premium finishes", "Polo field views"],
        image: "/grand-polo-club-emaar/24.png",
      },
      {
        name: "Townhouses",
        tag: "Modern living spaces in Equestra cluster",
        perks: ["Green space access", "Modern architecture", "Community amenities", "Family-friendly"],
        image: "/grand-polo-club-emaar/11.png",
      },
      {
        name: "Premium Villas",
        tag: "Ultra-luxury residences with exclusive access",
        perks: ["Larger plots", "Premium views", "Custom finishes", "Exclusive access"],
        image: "/grand-polo-club-emaar/12.png",
      },
    ],
  },
  ...
  clusters: {
    title: "Master Plan & Neighborhood Clusters",
    subtitle:
    ...
    items: [
      {
        ...
        image: "/grand-polo-club-emaar/13.png",
      },
      {
        name: "Chevalia",
        ...
        image: "/grand-polo-club-emaar/19.png",
      },
      {
        name: "Selvara",
        ...
        image: "/grand-polo-club-emaar/16.png",
      },
    ],
  },
  ...
  amenities: {
    ...
    items: [
      ...
      },
      {
        ...
        image: "/grand-polo-club-emaar/7.png",
      },
      {
        title: "Green Parks",
        description: "Extensive landscaped gardens and walking trails",
        image: "/grand-polo-club-emaar/6.png",
      },
      {
        title: "Clubhouse",
        description: "Social hub with viewing areas and dining options",
        image: "/grand-polo-club-emaar/5.png",
      },
      {
        title: "Equestrian Club",
        description: "Central polo fields and stables form the sporting heart",
        image: "/grand-polo-club-emaar/2.png",
      },
      {
        title: "24/7 Security",
        description: "Gated community with comprehensive security",
        image: "/grand-polo-club-emaar/8.png",
      },
    ],
  },

  whyChoose: {
    title: "Why Choose Grand Polo Club & Resort",
    subtitle:
      "Grand Polo Club & Resort by Emaar stands out among Dubai\u2019s luxury communities for several key reasons:",
    points: [
  ...
  gallery: {
    ...
    images: [
      { src: "/grand-polo-club-emaar/1.png", alt: "Grand Polo Club aerial view" },
      { src: "/grand-polo-club-emaar/2.png", alt: "Crystal lagoon and beach area" },
      { src: "/grand-polo-club-emaar/3.png", alt: "Modern coastal villas" },
      { src: "/grand-polo-club-emaar/4.png", alt: "Townhouse community layout" },
      { src: "/grand-polo-club-emaar/5.png", alt: "Marina and water sports facilities" },
      { src: "/grand-polo-club-emaar/6.png", alt: "Community amenities and parks" },
      { src: "/grand-polo-club-emaar/7.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/8.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/9.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/10.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/11.png", alt: "Townhouse exteriors" },
      { src: "/grand-polo-club-emaar/12.png", alt: "Premium villas" },
      { src: "/grand-polo-club-emaar/13.png", alt: "Equestra cluster" },
      { src: "/grand-polo-club-emaar/14.png", alt: "Community views" },
      { src: "/grand-polo-club-emaar/15.png", alt: "Landscaped gardens" },
      { src: "/grand-polo-club-emaar/16.png", alt: "Selvara nature walks" },
      { src: "/grand-polo-club-emaar/17.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/18.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/19.png", alt: "Chevalia villas" },
      { src: "/grand-polo-club-emaar/20.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/21.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/22.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/23.png", alt: "Community amenities" },
      { src: "/grand-polo-club-emaar/24.png", alt: "Luxury villas" },
    ],
  },
  ...
  cta: {
    ...
    description:
      "Connect with our property specialists for exclusive insights on Grand Polo Club & Resort. Discover available properties, off-plan opportunities, and investment potential in this unique equestrian community.",
    ctaText: "Request Exclusive Property Details",
    footnote:
      "Luxury villas & townhouses \u2022 Flexible off-plan payment plans \u2022 Equestrian lifestyle",
  },

  footer: {
    brandName: "GRAND POLO CLUB",
    tagline:
  ...
  form: {
    title: "Grand Polo Club Inquiry",
    subtitle: "Get details about luxury equestrian properties",
    sourceLabel: "Grand Polo Club Landing Page",
  },

  meta: {
    title: "Grand Polo Club Dubai | Equestrian Villas & Mansions | H&S",
    description:
      "Grand Polo Club & Resort Dubai — ultra-luxury equestrian community. Mansions, villas & polo estate lots. Limited availability. Enquire with H&S today.",
    keywords: [
    ...
    schemas: {
      place: {
        ...
        "@type": "Place",
        name: "Grand Polo Club, Dubai",
        url: "https://hsproperty.ae/communities/grand-polo-club",
        description:
          "Grand Polo Club is a premier residential community in Dubai. Explore off-plan and ready properties with H&S Real Estate.",
        address: {
          "@type": "PostalAddress",
        ...
        potentialAction: {
          "@type": "ViewAction",
          name: "View Properties in Grand Polo Club",
          target: "https://hsproperty.ae/communities/grand-polo-club",
        },
        breadcrumb: {
          "@type": "BreadcrumbList",
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Communities", item: "https://hsproperty.ae/communities" },
            {
              "@type": "ListItem",
              position: 3,
              name: "Grand Polo Club",
              item: "https://hsproperty.ae/communities/grand-polo-club",
            },
          ],
        },
      },
      /** Product + BreadcrumbList in one graph (canonical community URL). */
      graphProductBreadcrumb: {
        "@context": "https://schema.org",
        "@graph": [
          {
            "@type": "Product",
            name: "Grand Polo Club and Resort Dubai",
            url: "https://hsproperty.ae/communities/grand-polo-club",
            description:
              "Grand Polo Club and Resort by Emaar — ultra-luxury equestrian community in Dubai. Mansions, villas, and polo estate lots.",
            brand: {
              "@type": "Brand",
  ...
  thankyou: {
    communityName: "Grand Polo Club & Resort",
    description:
    ...
    returnLabel: "Back to Grand Polo Club & Resort",
  },
};
