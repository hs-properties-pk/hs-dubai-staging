// app/the-valley/thankyou/page.js
...
export const metadata = {
  title: "Thank You - The Valley by Emaar | HS Property",
  description:
    "Thank you for your inquiry about The Valley by Emaar. Our property specialist will contact you shortly.",
  robots: "noindex, nofollow",
};

export default function TheValleyThankYouPage() {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#EAF1F8] text-[#0F2748] p-6">
      <div className="max-w-xl w-full bg-white/95 backdrop-blur-md p-10 md:p-16 rounded-3xl shadow-2xl text-center border border-white/60">
        ...
        <p className="text-lg text-[#2C3E50] font-custom3 mb-8">
          Your inquiry regarding The Valley by Emaar has been successfully
