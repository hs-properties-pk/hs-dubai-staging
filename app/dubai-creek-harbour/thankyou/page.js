...
export const metadata = {
  title: "Thank You - Dubai Creek Harbour | HS Property",
  description:
    "Thank you for your inquiry about Dubai Creek Harbour. Our property specialist will contact you shortly.",
  robots: "noindex, nofollow",
};

export default function DubaiCreekHarbourThankYouPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-950 text-slate-50 p-6">
      <div className="max-w-xl w-full bg-slate-900 backdrop-blur-md p-10 md:p-16 rounded-3xl shadow-2xl text-center border border-slate-700">
        ...
        <p className="text-lg text-slate-300 mb-8 leading-relaxed">
          Your inquiry regarding Dubai Creek Harbour by Emaar has been successfully
          submitted. A property specialist will contact you within 24 hours with
          more information about our luxury waterfront community at Dubai Creek Harbour.
        </p>

        <div className="space-y-4">
          <Link
            href="/dubai-creek-harbour"
          ...
          >
            ...
            Return to Dubai Creek Harbour Page
          </Link>
