...
export const metadata = {
  title: "Thank You - Rashid Yachts & Marina | HS Property",
  description:
    "Thank you for your inquiry about Rashid Yachts & Marina. Our property specialist will contact you shortly.",
  robots: "noindex, nofollow",
};

export default function RashidYachtsMarinaThankYouPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-950 text-slate-50 p-6">
      <div className="max-w-xl w-full bg-slate-900 backdrop-blur-md p-10 md:p-16 rounded-3xl shadow-2xl text-center border border-slate-700">
        ...
        <p className="text-lg text-slate-300 mb-8 leading-relaxed">
          Your inquiry regarding Rashid Yachts & Marina has been successfully
          submitted. A property specialist will contact you within 24 hours with
          more information about our luxury waterfront apartments at Rashid
          Yachts & Marina.
        </p>

        <div className="space-y-4">
          <Link
            href="/rashid_yachts_marina"
            className="inline-flex items-center justify-center px-8 py-4 bg-cyan-500 text-white rounded-lg font-bold shadow-xl hover:bg-cyan-600 transition-all duration-300 transform hover:scale-105 group"
          >
            <FaChevronLeft className="mr-2 transition-transform group-hover:-translate-x-1" />
            Return to Rashid Yachts & Marina Page
          </Link>
